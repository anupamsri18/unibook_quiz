        ...
        <div class="navbar-header">
            ...
            <div class="container row">
                <a class="navbar-brand col-lg-3 " style="color: #f3e8e8" href="#"> <?php
                    ...
                    ?> </a>
                <a class="navbar-brand col-lg-1 " style="color: #f3e8e8" href="#"> FACULTY </a>
            ...
            <ul class="nav navbar-top-links navbar-right ">
                ...
                <li class="dropdown " style="float:right">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="facultyProfileDetails.php"><i class="fa fa-user fa-fw"></i> User Profile</a>
                        </li>
                        <li><a href="facultyProfileUpdate.php"><i class="fa fa-gear fa-fw"></i> Settings</a>
                        </li>
                        <li class="divider"></li>
    ...
    <div class="navbar-default  sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="faculty.php?q=1"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                </li>
                <li>
                    <a href="faculty.php?q=3"><i class="fa fa-fw fa-table"></i> User Feedback</a>
                </li>
                <li>
                    <a href="faculty.php?q=111"><i class="fa fa-fw fa-edit"></i> Ranking</a>
                </li>
                <li>
